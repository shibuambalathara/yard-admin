export const formStyle={data:` border   shadow-xl grid grid-cols-1   gap-y-3  p-8`}
export const inputStyle={data:`py-1 px-4 block w-72 mb-1 mt-2 hide-number-arrows text-gray-600 focus:outline-none focus:border font-normal  h-10 flex items-center pl-3 text-sm border-gray-300 rounded border `}
...
export const loginInputStyle={data:`py-1 px-4 hide-number-arrows block w-full shadow-sm border border-grey-600 text-gray-900  focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 `}
