...
const IndividualReleaseInitiated = ({ releaseId }) => {
  ...
  console.log("yard_name",vehicleData?.vehicle_ownership?.vehicle?.yard?.yard_name);
        ...
        <div>
          ...
          <div className="border grid grid-cols-1 md:grid-cols-3 gap-3 place-items-center mt-4 py-4">
            <div>
              ...
              <p className={inputStyle?.data}>{vehicleData?.vehicle_ownership?.vehicle?.yard?.yard_name}</p>
            </div>
            <div>
