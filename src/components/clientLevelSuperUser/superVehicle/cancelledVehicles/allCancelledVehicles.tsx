...
const AllCancelledVehicles = () => {
  ...
  const FetchAllYards = useCallback(async () => {
    try {
      ...
      console.log("error FetchAllYards",error);
  ...
  return (
    <div className="w-full">
      ...
      <div className=" grid lg:grid-cols-3 grid-cols-1 w-full  gap-4     place-items-start pt-8 px-5">
        <div>
...
const View = (row) => {
  ...
  return (
    <div className="flex justify-center items-center border space-x-1 bg-gray-700 text-white p-1 rounded-md px-2">
      ...
      <Link
        href={`/vehiclesSuperOrg/cancelledVehicles/${row.original.id}`}
        target="_blank"
