...
const ConfirmationModal = ({ isOpen, onCancel, onConfirm }) => {
    ...
    return (
      <div className="fixed top-0 left-0 w-full h-screen flex items-center justify-center bg-black bg-opacity-50 z-50 backdrop-blur-sm">
        <div className="bg-white w-full md:max-w-md mx-auto rounded-lg shadow-lg overflow-hidden animate-fade-in-down">
          <div className="relative p-6">
            ...
            <p className="text-xs text-red-700">*Please note that this action is irreversible.</p>
            </div>
